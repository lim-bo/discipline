...
func (mr *MockUsersRepositoryIMockRecorder) Create(ctx, user any) *gomock.Call {
...
func (mr *MockUsersRepositoryIMockRecorder) Delete(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersRepositoryIMockRecorder) FindByID(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersRepositoryIMockRecorder) FindByName(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersRepositoryIMockRecorder) Update(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockHabitsRepositoryIMockRecorder) Create(ctx, habit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockHabitsRepositoryIMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHabitsRepositoryIMockRecorder) GetByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHabitsRepositoryIMockRecorder) GetByUserID(ctx, uid, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Update indicates an expected call of Update.
func (mr *MockHabitsRepositoryIMockRecorder) Update(ctx, habit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHabitChecksRepositoryIMockRecorder) CountByHabitID(ctx, habitID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockHabitChecksRepositoryIMockRecorder) Create(ctx, habitID, date any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockHabitChecksRepositoryIMockRecorder) Delete(ctx, habitID, date any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHabitChecksRepositoryIMockRecorder) Exists(ctx, habitID, date any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHabitChecksRepositoryIMockRecorder) GetByHabitAndDateRange(ctx, habitID, from, to any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockHabitChecksRepositoryI) GetCurrentStreak(ctx context.Context, habitID uuid.UUID) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHabitChecksRepositoryIMockRecorder) GetCurrentStreak(ctx, habitID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCurrentStreak", reflect.TypeOf((*MockHabitChecksRepositoryI)(nil).GetCurrentStreak), ctx, habitID)
}
...
func (mr *MockHabitChecksRepositoryIMockRecorder) GetLastCheckDate(ctx, habitID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockHabitChecksRepositoryI) GetMaxStreak(ctx context.Context, habitID uuid.UUID) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHabitChecksRepositoryIMockRecorder) GetMaxStreak(ctx, habitID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxStreak", reflect.TypeOf((*MockHabitChecksRepositoryI)(nil).GetMaxStreak), ctx, habitID)
}
...
func (m *MockPgConnection) Begin(ctx context.Context) (v5.Tx, error) {
	m.ctrl.T.Helper()
...
func (m *MockPgConnection) Query(ctx context.Context, sql string, args ...any) (v5.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockPgConnection) QueryRow(ctx context.Context, sql string, args ...any) v5.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range args {
		varargs = append(varargs, a)
